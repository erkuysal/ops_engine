...
export OPS_SETUP_FILE OPS_PROJECT_STATE_DIR OPS_PROJECT_LOG_DIR OPS_PROJECT_RUN_DIR OPS_PROJECT_GENERATED_DIR OPS_PROJECT_HISTORY_DIR OPS_PROFILES_DIR
